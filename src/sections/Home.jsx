...
const socials = [
  {
    Icon: CgProfile,
    label: "Codolio",
    href: "https://codolio.com/profile/Manish_Dewangan",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
  ...
  { Icon: FaXTwitter, label: "x", href: "https://x.com/Manishdew1302" },
  {
    Icon: FaInstagram,
    label: "Instagram",
    href: "https://www.instagram.com/manish_dewangan_13/",
  },
];
...
const Home = () => {
  const roles = useMemo(
    () => ["MERN Stack Developer", "Android App Developer"],
    [],
  );
